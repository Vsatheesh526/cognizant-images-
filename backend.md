                ...
                <items jcr:primaryType="nt:unstructured">
                    ...
                    <basic
                        ...
                        <items jcr:primaryType="nt:unstructured">
                            ...
                            <!-- Text Section (shows only when contentType = "text") -->
                            <textSection
                                jcr:primaryType="nt:unstructured"
                                sling:resourceType="granite/ui/components/coral/foundation/container"
                                ...
                                <granite:data
                                    jcr:primaryType="nt:unstructured"
                                    granite:visibility-condition="contentType"
                                    granite:visibility-condition-value="text"/>
                                ...
                                <items jcr:primaryType="nt:unstructured">
                                    ...
                                    <fontSize
                                        ...
                                        <items jcr:primaryType="nt:unstructured">
                                            <small jcr:primaryType="nt:unstructured" text="Small" value="12px"/>
                                            <medium jcr:primaryType="nt:unstructured" text="Medium" value="16px"/>
                                            <large jcr:primaryType="nt:unstructured" text="Large" value="20px"/>
                                        </items>
                                    </fontSize>
                                </items>
                            </textSection>
                            
                            <!-- Image Section (shows only when contentType = "image") -->
                            <imageSection
                                jcr:primaryType="nt:unstructured"
                                sling:resourceType="granite/ui/components/coral/foundation/container"
                                ...
                                <granite:data
                                    jcr:primaryType="nt:unstructured"
                                    granite:visibility-condition="contentType"
                                    granite:visibility-condition-value="image"/>
                            ...
                            <!-- Video Section (shows only when contentType = "video") -->
                            <videoSection
                                jcr:primaryType="nt:unstructured"
                                sling:resourceType="granite/ui/components/coral/foundation/container"
                                granite:hidden="{Boolean}true">
                                ...
                                <granite:data
                                    jcr:primaryType="nt:unstructured"
                                    granite:visibility-condition="contentType"
                                    granite:visibility-condition-value="video"/>
                                
                                <items jcr:primaryType="nt:unstructured">
                                    <videoUrl
                                        jcr:primaryType="nt:unstructured"
                                        sling:resourceType="granite/ui/components/coral/foundation/form/textfield"
                                        fieldLabel="Video URL (YouTube/Vimeo)"
                                        name="./videoUrl"
                                        required="{Boolean}true"/>
                                    <videoThumbnail
                                        jcr:primaryType="nt:unstructured"
